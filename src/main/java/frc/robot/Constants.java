...
public final class Constants {
  ...
  public static final class CoralPlacement {
    ...
    static {
      ...
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(544.87), Units.inchesToMeters(152.03), Rotation2d.fromDegrees(180)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(544.87), Units.inchesToMeters(164.97), Rotation2d.fromDegrees(180)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(535.08), Units.inchesToMeters(181.89), Rotation2d.fromDegrees(240)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(523.90), Units.inchesToMeters(188.32), Rotation2d.fromDegrees(240)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(504.39), Units.inchesToMeters(188.32), Rotation2d.fromDegrees(300)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(493.16), Units.inchesToMeters(181.89), Rotation2d.fromDegrees(300)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(483.44), Units.inchesToMeters(164.97), Rotation2d.fromDegrees(0.0)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(483.44), Units.inchesToMeters(152.03), Rotation2d.fromDegrees(0.0)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(493.16), Units.inchesToMeters(135.15), Rotation2d.fromDegrees(60)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(504.39), Units.inchesToMeters(128.65), Rotation2d.fromDegrees(60)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(523.90), Units.inchesToMeters(128.65), Rotation2d.fromDegrees(120)));
      coordinatesCoralRed.add(new Pose2d(Units.inchesToMeters(535.08), Units.inchesToMeters(135.15), Rotation2d.fromDegrees(120)));
    }
    ...
    static {
      ...
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(146.052), Units.inchesToMeters(164.97), Rotation2d.fromDegrees(0.0)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(146.052), Units.inchesToMeters(152.03), Rotation2d.fromDegrees(0.0)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(155.43), Units.inchesToMeters(135.15), Rotation2d.fromDegrees(60)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(166.65), Units.inchesToMeters(128.65), Rotation2d.fromDegrees(60)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(136.51), Units.inchesToMeters(128.65), Rotation2d.fromDegrees(120)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(197.69), Units.inchesToMeters(135.15), Rotation2d.fromDegrees(120)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(207.48), Units.inchesToMeters(152.03), Rotation2d.fromDegrees(180)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(207.48), Units.inchesToMeters(164.97), Rotation2d.fromDegrees(180)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(197.69), Units.inchesToMeters(181.89), Rotation2d.fromDegrees(240)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(186.51), Units.inchesToMeters(188.32), Rotation2d.fromDegrees(240)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(166.65), Units.inchesToMeters(188.32), Rotation2d.fromDegrees(300)));
      coordinatesCoralBlue.add(new Pose2d(Units.inchesToMeters(155.43), Units.inchesToMeters(181.89), Rotation2d.fromDegrees(300)));
    }
